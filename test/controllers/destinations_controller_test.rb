...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { address: @destination.address, description: @destination.description, name: @destination.name, participant_id: @destination.participant_id, trip_id: @destination.trip_id }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { address: @destination.address, description: @destination.description, name: @destination.name, participant_id: @destination.participant_id, trip_id: @destination.trip_id }
    assert_redirected_to destination_path(assigns(:destination))
  end
